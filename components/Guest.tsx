...
const Guest = () => {
  return (
    <div className="relative flex h-[calc(100vh-64px)] w-full items-center justify-center bg-emerald-50 dark:bg-[#05241d]">
      {/* Landing Page Content */}
      <div className="relative z-20 text-center px-4">
        <div className="grid lg:grid-cols-2 gap-10 mx-15 items-center">
          <div >
            <h1 className="text-5xl lg:text-6xl font-bold text-start dark:text-white text-[#073127] mb-6 leading-tight">
              <TextGenerateEffect words="Is your money vanishing faster than your weekend?" />

            </h1>

            <p className="text-xl text-start text-gray-600 dark:text-gray-300 mb-8 leading-relaxed max-w-lg">
      ...
      Get Started
            ...
            <div className="relative">
              <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-sm mx-auto">
                <div className="mb-6">
                  <h3 className="text-gray-900 font-semibold mb-4">Your Expenses</h3>
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-lg p-4 max-w-48">
                <div className="flex items-center space-x-2 mb-2">
                  <div className="w-6 h-6 bg-emerald-100 rounded-full flex items-center justify-center">
                    <span className="text-xs font-bold text-emerald-600">#1</span>
                  </div>
                  <span className="text-sm font-semibold text-emerald-500">AI Savio</span>
                </div>
                <p className="text-xs text-gray-500">
                 Take charge with AI-powered tracking designed for clarity and growth.
                </p>
              </div>

              <div className="absolute -bottom-7 -left-1 bg-white rounded-2xl shadow-lg p-4 max-w-48">
                <div className="flex items-center space-x-2 mb-2">
                  <div className="w-6 h-6 bg-emerald-100 rounded-full flex items-center justify-center">
                    <span className="text-xs font-bold text-emerald-600">#2</span>
                  </div>
                  <span className="text-sm font-semibold text-emerald-500">Get Started</span>
                </div>
                <p className="text-xs text-gray-500">
                  Sign up with your email and start tracking your expenses hassle-free!
                </p>
              </div>
            </div>
